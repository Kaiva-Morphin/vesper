...
pub enum RustpermsOperation {
    ...
    GroupAddGroupsToInherit(GroupUID, Vec<GroupUID>),
    GroupAddDependentGroups(GroupUID, Vec<GroupUID>),
    GroupRemoveToInherit(GroupUID, Vec<GroupUID>),
    GroupRemoveDependentGroups(GroupUID, Vec<GroupUID>),
